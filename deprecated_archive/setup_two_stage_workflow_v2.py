...
def run():
    print("--- 👮 SETTING UP 2-STAGE APPROVAL WORKFLOW (FIXED) ---")
    ...
    # 2. DEFINE WORKFLOW STATES (With Valid Styles)
    states = [
        {"state": "Draft", "doc_status": 0, "allow_edit": "Tender User", "style": "Inverse"}, # Gray
        {"state": "Pending Review", "doc_status": 0, "allow_edit": "Tender Manager", "style": "Warning"}, # Yellow/Orange
        {"state": "Pending Final Approval", "doc_status": 0, "allow_edit": "Tender Director", "style": "Primary"}, # Blue
        {"state": "Approved to Bid", "doc_status": 1, "allow_edit": "", "style": "Success"}, # Green (Submitted)
        {"state": "Rejected", "doc_status": 2, "allow_edit": "", "style": "Danger"} # Red (Cancelled)
    ]
