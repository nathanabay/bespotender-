...
def run():
    print("--- 🚀 POPULATING DATA & FINALIZING DASHBOARD ---")

    # 1. GENERATE SAMPLE TENDERS (To fix "No Data")
    tenders = [
        {
            ...
            "bond_amount": 50000,
            "bond_status": "Active",
            "deadline": add_days(nowdate(), 2) # Closing in 2 days
        },
        {
        ...
        },
        {
            ...
            "bond_amount": 12000,
            "bond_status": "Pending",
            "deadline": add_days(nowdate(), 5) # Closing in 5 days
        }
    ]
    ...
    if frappe.db.exists("Workspace", ws_name):
        ...
        # Define the structure again to ensure clean slate
        ws_content = [
