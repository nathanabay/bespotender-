...
def run():
    print("--- 👮 SETTING UP 2-STAGE APPROVAL WORKFLOW (FINAL V4) ---")
    ...
    # 3. DEFINE WORKFLOW STATES (With Mandatory Roles Assigned)
    states = [
        ...
        # FIXED: Assigned roles to these states to satisfy mandatory requirement
        {"state": "Approved to Bid", "doc_status": 1, "allow_edit": "Tender Director", "style": "Success"}, 
        {"state": "Rejected", "doc_status": 2, "allow_edit": "Tender Manager", "style": "Danger"}
    ]
