...
def run():
    print("--- 🔧 UPDATING BOND LOGIC: PERCENTAGE FEES ---")
...
frappe.ui.form.on('Tender Opportunity', {
                    ...
                    let d = new frappe.ui.Dialog({
                        ...
                        fields: [
                            ...
                            },
                            {
                                ...
                                fieldtype: 'Float',
                                default: 0.5,
                                description: 'Enter percentage (e.g., 0.5 for 0.5%)',
                                onchange: function() {
                                    // Live calculation of fee amount
                            ...
                            },
                            {
                                ...
                                fieldtype: 'Currency',
                                read_only: 1,
                                default: (frm.doc.bond_amount * 0.005) // Default 0.5%
                            },
                            {
                        ...
                        primary_action: function(values) {
                            ...
                            // 2. DEBIT ASSET (Bond Principal Only)
                            accounts_list.push({
                            ...
                            // 3. DEBIT EXPENSE (Calculated Fee)
                            if (fee_val > 0) {
                                accounts_list.push({
                            ...
                            frappe.new_doc('Journal Entry', {
                                ...
                                "user_remark": `Issuance of Bid Bond (${values.commission_rate}% fee) for: ${frm.doc.title}`,
    ...
    print("--- ✅ PERCENTAGE CALCULATION DEPLOYED ---")
